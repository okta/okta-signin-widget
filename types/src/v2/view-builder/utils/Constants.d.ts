...
export namespace AUTHENTICATOR_ALLOWED_FOR_OPTIONS {
    const ANY: string;
    const SSO: string;
...
export namespace AUTHENTICATION_CANCEL_REASONS {
    const LOOPBACK_FAILURE: string;
    const OV_ERROR: string;
    const USER_CANCELED: string;
}
