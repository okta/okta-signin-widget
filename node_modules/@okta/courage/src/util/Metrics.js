/* eslint max-len:0, max-statements:0, complexity:0 */
define([
  'jquery',
  'underscore',
  'mixpanel',
...
function ($, _, mixpanel, Class, Logger) {
  ...
  return Class.extend({
    ...
    */
    ...
    initialize: function (options) {
      ...
      this.__sendMixpanelEvents = isProd || options.sendEventsInDev;
    ...
    track: function (eventName, properties) {
      ...
      if (this.__sendMixpanelEvents) {
        this.__instance.track(eventName, propertiesToSend, function () {
          deferred.resolve();
        });
      }
      else {
        log('track', eventName, propertiesToSend);
    ...
    timeEvent: function (eventName) {
      if (this.__sendMixpanelEvents) {
        this.__instance.time_event(eventName);
      }
      else {
        log('time_event', eventName);
      }
    }
