...
function (_, $, TemplateUtil, StringUtil, BaseView,
  ...
  var events = {
    ...
    'focusin .okta-form-input-field input': 'markFocusedInput'
  };
  ...
  */
  ...
  return BaseView.extend({
    ...
    */
    ...
    /**
     * Adds class "focused-input" to input container and deletes this class from other inputs
     * @param {Object} e jQuery event object
     */
    markFocusedInput: function (e) {
      this.getInputs().forEach(function (item) {
        item.$el.find('.okta-form-input-field').removeClass('focused-input');
      });

      e.target.closest('.okta-form-input-field').className += ' focused-input';
    }
  });
