  ...
  */
  ...
  return BaseInput.extend({
    ...
    constructor: function (options) {
      ...
      if (options && options.params && options.params.idAttribute) {
        this.idAttribute = options.params.idAttribute;
      }
      if (options && options.params && options.params.extraParams) {
        this.extraParams = options.params.extraParams;
      }
    ...
    _autoSuggest: function () {
      var options = {
        ...
        retrieveLimit: this.options.params && this.options.params.retrieveLimit || this.retrieveLimit,
        selectionLimit: this.options.params && _.resultCtx(this.options.params, 'selectionLimit', this) ||
          _.result(this, 'selectionLimit'),
    ...
    batchFetch: function (ids) {
      return BatchAjaxUtil.getByIds({ url: this.apiURL,
