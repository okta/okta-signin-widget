@mixin btn-theme-generator($bg-color, $gradient-factor, $text-color, $border-factor, $shadow-opacity, $include-hover, $important: '') {
  ...
  @include background-with-css2-fallback(linear-gradient($_default-bg-start-color, $_default-bg-end-color), $_default-bg-end-color $i);
  border-color: $_default-border-color $_default-border-color $_default-border-bottom-color $i;
  @include box-shadow(rgba($black, $shadow-opacity) 0 1px 0, rgba($white, 0.1) 0 1px 0 0 inset $i);
  ...
  @if $include-hover {
    &:hover {
      ...
      @include background-with-css2-fallback(linear-gradient($_hover-bg-start-color, $_hover-bg-end-color), $_hover-bg-end-color $i);
    ...
    &.button-down {
      ...
      @include background-with-css2-fallback(linear-gradient($_active-bg-start-color, $_active-bg-end-color), $_active-bg-end-color $i);
      @include box-shadow(rgba($black, 0.12) 0 1px 1px 0 inset $i);
    }
  }
  ...
  &.btn-disabled .button-down {
    ...
    @include background-with-css2-fallback($_disabled-bg-color $i);
    @include box-shadow(rgba($black, $shadow-opacity) 0 1px 0 $i);
