...
.data-list {
  ...
  border-width: 1px;
  border-style: solid;
  border-color: $border-color-default $border-color-default $border-bottom-color-default;
...
.data-list-toolbar {
  padding: 10px;
  border-bottom: 1px solid $border-bottom-color-default;
...
.data-list-sidebar-left {
  .data-list-content {
    border-left: 1px solid $data-list-content-border-color;
    border-radius: 0 0 $border-radius-default 0;
  }

  .data-list-content-wrap .data-list-toolbar {
    background: $component-bg-color-dark;
    border-top-right-radius: $border-radius-default;
    border-left: 1px solid $data-list-content-border-color;
  }
...
.data-list-sidebar-right {
  .data-list-content {
    border-right: 1px solid $data-list-content-border-color;
    border-bottom-left-radius: $border-radius-default;
    border-top-left-radius: $border-radius-default;
  }
}
...
.data-list-sidebar-wrap .o-form-head {
  ...
  padding: 15px 10px;
  line-height: 15px;
  border-bottom: 1px solid $component-bg-color-dark;
}
...
.data-list-pager-footer {
  ...
  a {
    ...
    text-align: center;
    line-height: 38px;
    border: 1px solid $data-list-pager-border-color;
    border-radius: 3px;
    margin: 20px 20px 0;
...
.data-list-pager-alpha {
  margin: $border-radius-default 0 0;
}
...
.data-list-empty-img {
  ...
  left: 50%;
  margin-left: -24px;
  background-image: url(/img/ui/backgrounds/data-list-empty.png);
  height: 48px;
  width: 48px;
}
...
.data-list-table-only {
  .data-list-secondary-header th:first-child,
  .data-list-numbers th:first-child {
    border-radius: 0;
  }
  tbody:last-child .data-list-numbers th:first-child {
    border-bottom-left-radius: $border-radius-default;
  }
  .data-list-secondary-header .data-list-called-out-header {
    color: #333333;
    font-weight: bold;
  ...
  .data-list-secondary-header th:last-child {
    border-radius: 0;
  }
  .data-list-secondary-header .data-list-called-out-header + th {
    border-left: 1px solid transparent;
  }
  .data-list-secondary-header th {
...
.data-list-inline-form {
  ...
  border-left: 1px solid $data-list-content-border-color;
  background: $component-bg-color-light;
}
