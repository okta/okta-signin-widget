...
app.generic.import.fail.roadblock=An import into Okta from ${app_name} - ${instance_name} would have removed ${app_unassignments} out of ${org_app_assignments} app assignments (${app_unassignemnt_percent}).
