...
reports.UserActivity.appData=\
  <b>Special format: ${appData}</b>

reports.UserActivity.username=\
  <a href="/admin/user/profile/view/${userId}">${userName}</a>
...
system_log_category.user_creation_failure=User Creation Failure
...
system_log_category.email_messages=Email Messages
system_log_category.universal_directory=Universal Directory
system_log_category.idp_authentication=IDP Authentication
...
system_log_category.user_self_service_password_reset=Self Service Password Reset
system_log_category.user_profile_update=User Profile Update
system_log_category.app_provision_failure=App Provisioning Failure
system_log_category.oauth2=OAuth 2.0

###############################################################################
# Report specific (Soon to be removed once "real" reports are added)
###############################################################################
...
#The message below is just for the Oktane Demo. This should be removed later.
core.user_auth.login_failed.policy_denied=Sign-in Failed: Access denied due to Sign-on policy: Blocked Countries
...
core.user_auth.super_user_app_accessed=Super User App accessed
...
core.user_auth.mfa_okta_verify_response=An invalid MFA attempt was made from suspicious Okta Verify Mobile App

core.user_auth.login_success=Sign-in successful
core.user_auth.logout_success=Sign-out successful
core.user_auth.session_created_using_token=Session created for user using API token
core.user_auth.session_expired=Session has expired
core.user_auth.session_clear=Sessions cleared
...
# Self Service
#
core.user_auth.self_service.invalid_recovery_token=Invalid recovery token was attempted for self-service operation: ${recovery_token}

#
# Self Service - password reset
#
core.user_auth.self_service.password_reset.unknown_user=Self-service password reset attempted for unknown user: ${okta_username}
core.user_auth.self_service.password_reset.suspended_user=Self-service password reset attempted for suspended user
core.user_auth.self_service.password_reset.shared_email=Self-service password reset attempted using shared email address: ${okta_username}
core.user_auth.self_service.password_reset.issued_recovery_token=Issued recovery token for self-service password reset. Token expires at ${token_expiration_time}
# SMS code issued is already handled by "core.user.sms.message_sent.self_service.password_reset"
# Recovery token issued via email is already handled by "core.user.email.message_sent.self_service.password_reset"
core.user_auth.self_service.password_reset.invalid_security_answer=User answered recovery question incorrectly for self-service password reset
core.user_auth.self_service.password_reset.invalid_recovery_token=Invalid recovery token was attempted for self-service password reset: ${recovery_token}
core.user_auth.self_service.password_reset.invalid_sms_code=Invalid SMS code was attempted for self-service password reset
core.user_auth.self_service.password_reset.invalid_user_state=Self-service password reset attempt denied due to invalid user state or policy
core.user_auth.self_service.password_reset=Password reset using self-service

#
# Self Service - account unlock
#
core.user_auth.self_service.account_unlock.already_unlocked=Self-service account unlock attempted for account that was already unlocked
core.user_auth.self_service.account_unlock.unknown_user=Self-service account unlock attempted for unknown user: ${okta_username}
core.user_auth.self_service.account_unlock.shared_email=Self-service account unlock attempted using shared email address: ${okta_username}
core.user_auth.self_service.account_unlock.issued_recovery_token=Issued recovery token for self-service account unlock. Token expires at ${token_expiration_time}
# SMS code issued is already handled by "core.user.sms.message_sent.self_service.account_unlock"
# Recovery token issued via email is already handled by "core.user.email.message_sent.self_service.account_unlock"
core.user_auth.self_service.account_unlock.invalid_security_answer=User answered recovery question incorrectly for self-service account unlock
core.user_auth.self_service.account_unlock.invalid_recovery_token=Invalid recovery token was attempted for self-service account unlock: ${recovery_token}
core.user_auth.self_service.account_unlock.invalid_sms_code=Invalid SMS code was attempted for self-service account unlock
core.user_auth.self_service.account_unlock=Account unlocked using self-service
...
cvd.user_profile_updated=User profile updated (\
  ...
  Attributes Modified: [${profile_properties_modified}])
cvd.mappings_updated=${direction} (\
  Source profile: ${source}, \
  Target profile: ${target}, \
  Added: [${mappings_added}], \
  Modified: [${mappings_modified}], \
  Deleted: [${mappings_deleted}])
cvd.appuser_profile_bootstrapped=Application User profile bootstrapped (Profile: ${profile_id})
cvd.appuser_profile_updated=${app_type} User profile updated (\
  Profile: ${profile_id}, \
  Attributes Added: [${profile_properties_added}], \
  Attributes Deleted: [${profile_properties_deleted}],\
  Attributes Modified: [${profile_properties_modified}])

platform.group_push.delete_appgroup=Group Push - deleting AppGroup (Mapping: ${mapping_id})
platform.group_push.activate_mapping=Group Push - activating mapping (Mapping: ${mapping_id})
platform.group_push.push_memberships=Group Push - pushing memberships (Mapping: ${mapping_id})
...
core.user.config.user_status.suspended=Okta user has been suspended
core.user.config.user_status.unsuspended=Okta user has been unsuspended
core.user.config.user_status.password_mass_expiry = Admin initiated Expire Passwords for all users
...
core.user.jit.error.read_only=Failed to JIT create user '${okta_username}' - system is in ${server_status} mode

#
# Group Rules
#
cvd.group_rule_triggered=Group membership rule triggered (\
  Reason: ${rule_status}, \
  Rule name: ${rule_name}, \
  Rule Id: ${rule_id}, \
  Group name: ${group_name}, \
  Group Id: ${group_id}, \
  Number of users added: ${num_users_added}, \
  Number of users removed: ${num_users_removed})
cvd.group_rule_invalidated= Group membership rule with id: ${rule_id} and name: ${rule_name} invalidated since ${deleted_resource_type} with id: ${deleted_resource_id} referenced in rule's ${referenced_section} has been deleted
core.user.added_to_rule_exclusion=User added to exclusion list of group membership rule with id: ${rule_id} and name: ${rule_name}.
cvd.group_rule_deactivated= Group membership rule with id: ${rule_id} and name: ${rule_name} is deactivated since ${deleted_resource_type} referenced in rule's ${referenced_section} has been deleted.

#
# Approval flow
#
approvalflow.self_service_turned_off=Self service has been disabled for the following app = (\
  Id: ${resource_id},\
  Name: ${resource_name}) because an approval workflow has been disabled and an approval workflow is required.
approvalflow.appInstance_approver_action=${approver_name} ${group_membership_info} ${action} the app request of ${requester_name}.\
( \
  Request Id: ${request_id},\
  AppInstance Id: ${resource_id},\
  AppInstance Name: ${resource_name},\
  Approver Id: ${approver_id},\
  Requester Id: ${requester_id},\
  Step sequence Number: ${step_seq_num}\
)
approvalflow.appInstance_request_status_changed=${resource_name} app request by ${requester_name} is ${request_status}\
( \
  Request Id: ${request_id},\
  AppInstance Id: ${resource_id},\
  AppInstance Name: ${resource_name},\
...
# CALL
#
core.user.call_made.factor=Call made for second factor: ${phonenumber}
core.user.call_to_send_otp.message_sent.verify=Call made to verify user's phone number: ${phonenumber}
core.user.call_to_send_otp.message_sent.mfa.challenge=Call made to challenge user's phone number: ${phonenumber}

#
# SMS
#
core.user.sms.message_sent.factor=SMS sent for second factor: ${phonenumber}
core.user.sms.message_sent.verify=SMS sent to verify user's phone number: ${phonenumber}
core.user.sms.message_sent.self_service.password_reset=SMS sent to initiate self-service password reset: ${phonenumber}
core.user.sms.message_sent.self_service.account_unlock=SMS sent to initiate self-service account unlock: ${phonenumber}
core.user.sms.message_sent.push_verify.activation=SMS sent to activate Okta Verify Push on mobile: ${phonenumber}

#
# Email
#
core.user.email.message_sent.self_service.password_reset=Email sent to initiate self-service password reset: ${address}
core.user.email.message_sent.self_service.account_unlock=Email sent to initiate self-service account unlock: ${address}
...
core.framework.ratelimit.exceeded=Rate limit exceeded

###############################################################################
# Core - Groups
###############################################################################

core.user_group_member.user_add=User added to group ${group_name} by ${trigger}
core.user_group_member.user_remove=User removed from group ${group_name} by ${trigger}

core.org.config.org_creation.success=Org created
core.org.config.org_creation.failure=Org creation failed
...
plugin.script_status=Status information from script execution

###############################################################################
# App
###############################################################################

app.generic.user_management.error.add_manager_to_user=Failed to push ${manager_atb} app user attribute for ${app_username} to ${app_name}
...
app.user_management.push_okta_password_update=Pushing User's Okta password to app
app.user_management.push_unique_password_update=Pushing unique password for User to app
...
app.user_management.push_new_user_success=Successfully pushed new user account to app
...
app.user_management.update_user_lifecycle_from_master_failed=Could not apply user status update on import: ${message}
app.user_management.unsuspend_user_after_confirm_failed=Could not unsuspend user after confirming assignment
...
app.user_management.app_group_member_import.insert.success=Successfully imported new member to an app group
app.user_management.app_group_member_import.insert.failure=Failed to import a new member to an app group
app.user_management.app_group_member_import.delete_success=Deleted member of the ${app_group_name} app group - ${app_username}
app.user_management.app_group_member_import.delete.success=Successfully deleted member of an app group
app.user_management.app_group_member_import.delete.failure=Failed to delete a member of an app group
...
app.user_management.user_group_import.create_failure=Failed to create ${group_name} group from app
app.user_management.user_group_import.update_failure=Failed to update ${user_group_name} group from app
...
app.user_management.grouppush.mapping.okta.users.ignored = ${ignored_okta_users} Okta users ignored while pushing group ${user_group_name} to AppInstance ${app_instance_id}
platform.grouppush.appgroup.not.found = No appGroup found for the user group id: {0}
app.user_management.grouppush.mapping.created = A Group Push mapping to the group ${user_group_name} has been created.
platform.grouppush.appgroup.oktamastered = Appgroup {0} is already Okta mastered
app.user_management.grouppush.pushed = Group Push group ${group_name} pushed to app.
app.user_management.grouppush.removed = Group Push group ${group_name} removed from app.
app.user_management.grouppush.updated = Group Push group ${group_name} updated in app.
...
app.generic.import.fail.roadblock=An import into Okta from ${app_name} - ${instance_name} would have removed ${app_unassignments} out of ${org_app_assignments} app assignments (${app_unassignment_percent}).
app.generic.import.fail.roadblock.reschedule_and_resume=The affected import from ${app_name} - ${instance_name} has been rescheduled.  All other imports will resume.
app.generic.import.fail.roadblock.resume=The affected import from ${app_name} - ${instance_name} has been canceled.  All other imports will resume.
app.generic.import.batch.complete=Imported data processed.
...
app.generic.show.password=Reveal password requested for User: ${app_username} App: ${app_name} Reauth: ${reauth}
...
app.app_instance.default_username_update=Application username format changed: {0} -> {1}
...
app.app_instance.sync_unique_password_enabled=Syncing unique passwords
app.app_instance.sync_unique_password_disabled=Stop syncing unique passwords
app.app_instance.refresh_sync_unique_password=Refreshing unique synced passwords
app.app_instance.cycle_synced_password_enabled=Cycling synced passwords enabled
app.app_instance.cycle_synced_password_disabled=Cycling synced passwords disabled
app.app_instance.user_termination_status.deactivate=Termination status for okta users set to Deactivate
app.app_instance.user_termination_status.suspend=Termination status for okta users set to Suspend
app.app_instance.reactivate_suspended_users_enabled=Reactivate suspended okta users enabled
app.app_instance.reactivate_suspended_users_disabled=Reactivate suspended okta users disabled
...
policy.rule.invalidated=Policy rule (id: ${policyRuleId}, type: ${policyRuleType}) invalidated in Policy (id: ${policyId}, type: ${policyType})
...
# Network Zones
#
zone.created=Network zone(id: ${networkZoneId}, type: ${networkZoneType}) created
zone.activated=Network zone(id: ${networkZoneId}, type: ${networkZoneType}) activated
zone.deactivated=Network zone(id: ${networkZoneId}, type: ${networkZoneType}) deactivated
zone.updated=Network zone(id: ${networkZoneId}, type: ${networkZoneType}) updated
zone.deleted=Network zone(id: ${networkZoneId}, type: ${networkZoneType}) deleted

zone.rule.disabled=Entity (id: ${policyRuleId}, type: ${policyRuleType}) using network zones has been disabled/deactivated when NETWORK_ZONES feature was disabled
...
app.admin.sso.login.success     = User logged in to the Admin app
app.admin.sso.no_response       = User attempted login to the Admin app with no token
app.admin.sso.bad_response      = User attempted login to the Admin app with invalid token
...
app.rich_client.instance_invalid_org=Rich client authentication failed: Invalid org for app instance id ${instance_id}
...
app.google.license_management.error.remove_license=Failed to remove license ${app_error_code}
app.google.license_management.error.assign_license=Failed to assign license ${app_error_code}
...
app.salesforce.user_management.failure.add_user_to_public_group=Failed to add user to public group: ${app_error_code}
app.salesforce.user_management.failure.remove_user_from_public_group=Failed to remove user from public group: ${app_error_code}
app.salesforce.user_management.failure.download_user_schema=Unable to download User schema from Salesforce
...
app.workday.api.error.connect-custom-report = Unable to establish connection to fetch custom report: ${app_error_code}
app.workday.api.error.get-custom-report-xsd-parsing = Unable to parse the custom report: ${app_error_code}
app.workday.api.error.parse-custom-report = Unable to parse the custom report: ${app_error_code}
app.workday.api.error.universal-directory-setup-error = Unable to set up universal directory: ${app_error_code}
app.workday.api.error.custom-report-unknown-failure = Unable to fetch custom report: ${app_error_code}
app.workday.api.error.get-employee-personal-info = Unable to find personal info for Workday employee: ${app_error_code}
app.workday.api.error.update-employee-personal-info = Unable to update personal info for Workday employee: ${app_error_code}
app.workday.api.error.user-management-error-download-app-schema = Unable to download Workday schema: ${app_error_code}
app.workday.api.error.user-management-error-push-profile-update = Unable to push profile update: ${app_error_code}
app.workday.api.get-custom-report-data-empty = The custom report data fetched for externalId: ${external_id} is empty.
...
app.zendesk.api.error.validation.error=Failed to import user ${username}, unsupported symbol in field ${field} = ${value}
...
app.confluence.api.error.deactivate.user=Failed to deactivate user from Confluence: ${app_error_code}
app.confluence.api.error.reactivate.user=Failed to reactivate user from Confluence: ${app_error_code}
app.confluence.api.error.check.user.exists=Failed to verify a user exists from Confluence: ${app_error_code}
app.confluence.api.error.check.group.exists=Failed to verify a group exists from Confluence: ${app_error_code}
app.confluence.api.error.get.user=Failed to download a user from Confluence: ${app_error_code}
...
app.confluence.api.error.download.users=Failed to download all user from Confluence: ${app_error_code}
app.confluence.api.error.create.new.user=Failed to create new a user: ${app_error_code}
app.confluence.api.error.remove.user=Failed to remove a user from Confluence: ${app_error_code}
app.confluence.api.error.create.new.group=Failed to create new a group: ${app_error_code}
app.confluence.api.error.remove.group=Failed to remove a group from Confluence: ${app_error_code}
app.confluence.api.error.add.user.to.group=Failed to assign a user to a group from Confluence: ${app_error_code}
app.confluence.api.error.remove.user.to.group=Failed to remove a user from a group from Confluence: ${app_error_code}
app.confluence.api.error.get.user.groups=Failed to download a user's groups from Confluence: ${app_error_code}
app.confluence.api.error.push.password.update=Failed to push a new password to a user to Confluence: ${app_error_code}
app.confluence.api.error.push.profile.update=Failed to push a profile to a user to Confluence: ${app_error_code}
app.confluence.api.error.import.user.profile=Failed to download a user's profile from Confluence: ${app_error_code}
...
app.office365.api.error.get.company.dirsync.failure = Unable to read Office 365 directory sync for the company, received error: ${app_error_code}, user: ${app_username}
app.office365.api.error.set.company.dirsync.status.failure = Unable to enable Office 365 directory sync for the company, because 'Directory Sync' value of ${app_error_code} in Azure Active Directory is unsupported.  Please visit the Azure Active Directory portal and set 'Directory Sync' state to Activated.
app.office365.api.error.get.company.dirsync.status.failure = Unable to provision user ${app_username} to Office 365, because 'Directory Sync' value of ${app_error_code} in Azure Active Directory is unsupported.  Please visit the Azure Active Directory portal and set 'Directory Sync' state to Activated and retry.
...
app.office365.api.error.set.domain.federation.failure = Unable to setup the domain federation, received error: ${app_error_code}
app.office365.api.error.set.domain.federation.failure.domain.not.found =  Unable to setup the domain federation because the specified domain was not found: domain=${domain}.
app.office365.api.error.set.domain.federation.failure.domain.default =  Unable to setup the domain federation because the specified domain is the default domain: domain={domain}.
...
app.office365.api.error.remove.domain.federation.failure = Unable to remove the domain federation, received error: ${app_error_code}
app.office365.api.error.remove.domain.federation.failure.domain.not.found =  Unable to remove the domain federation because the specified domain was not found: domain=${domain}.
...
app.office365.api.error.validate.admin.creds = User ${admin_user_name} does not have the Company Administrator role. Please try again with a user which has this role.
app.office365.api.sync.complete = User sync completed. with total ${count_user} processed (${count_user_delete} deletion), of those processed ${count_user_failure} failed (${count_user_delete_failure} deletion)
app.office365.api.sync.job.complete = Sync job completed. with total ${count_object} objects processed, of those processed objects ${count_object_failure} failed
app.office365.api.sync.job.complete.user = Sync job completed. with total ${count_user} users processed (${count_user_delete} deletion), of those processed users ${count_user_failure} failed (${count_user_delete_failure} deletion)
app.office365.api.sync.job.complete.group = Sync job completed. with total ${count_group} groups processed (${count_group_delete} deletion), of those processed groups ${count_group_failure} failed (${count_group_delete_failure} deletion)
app.office365.api.sync.job.complete.contact = Sync job completed. with total ${count_contact} contacts processed (${count_contact_delete} deletion), of those processed contacts ${count_contact_failure} failed (${count_contact_delete_failure} deletion)
...
app.office365.api.error.no-licenses-available=Unable to assign licenses to the user. These licenses have no available seats: ${app_license}. These licenses have only suspended (unassignable) seats left: ${app_license_suspended}
app.office365.api.error.conflicting-licenses=Unable to assign licenses to the user due to license conflicts. Please remove one of the licenses and try again. Conflict details: ${app_error_code}
...
app.office365.license.conversion.job.download.or.migration.failed = Download of new or migration of existing licenses failed during Office 365 license conversion, received error: ${app_error_code}
app.office365.license.conversion.job.begin.migration.users.v1.to.v0 = Begin migrating licenses from v1 to v0 for app users during Office 365 license conversion. Total App users to be migrated: ${count_app_users}
app.office365.license.conversion.jo.begin.migration.gaas.v1.to.v0 = Begin migrating licenses from v1 to v0 for group app assignments during Office 365 license conversion. Total group app assignments to be migrated: ${count_app_gaas}
app.office365.license.conversion.job.begin.migration.users.v0.to.v1 = Begin migrating licenses from v0 to v1 for app users during Office 365 license conversion. Total App users to be migrated: ${count_app_users}
app.office365.license.conversion.job.begin.migration.gaas.v0.to.v1 = Begin migrating licenses from v0 to v1 for group app assignments during Office 365 license conversion. Total group app assignments to be migrated: ${count_app_gaas}
app.office365.license.conversion.job.end.count.migration.users.v1.to.v0 = End migrating licenses from v1 to v0 for app users during Office 365 license conversion. App users migrated: ${count_app_users}
app.office365.license.conversion.job.end.count.migration.gaas.v1.to.v0 = End migrating licenses from v1 to v0 for group app assignments during Office 365 license conversion. Group app assignments migrated: ${count_app_gaas}
app.office365.license.conversion.job.end.count.migration.users.v0.to.v1 = End migrating licenses from v0 to v1 for app users during Office 365 license conversion. App users migrated: ${count_app_users}
app.office365.license.conversion.job.end.count.migration.gaas.v0.to.v1 = End migrating licenses from v0 to v1 for group app assignments during Office 365 license conversion. Group app assignments migrated: ${count_app_gaas}
app.office365.license.conversion.job.end.migration.users.v1.to.v0 = End migrating licenses from v1 to v0 for all app users during Office 365 license conversion. App users migrated: ${count_app_users}
app.office365.license.conversion.job.end.migration.gaas.v1.to.v0 = End migrating licenses from v1 to v0 for all group app assignments during Office 365 license conversion. Group app assignments migrated: ${count_app_gaas}
app.office365.license.conversion.job.end.migration.users.v0.to.v1 = End migrating licenses from v0 to v1 for all app users during Office 365 license conversion. App users migrated: ${count_app_users}
app.office365.license.conversion.job.end.migration.gaas.v0.to.v1 = End migrating licenses from v0 to v1 for all group app assignments during Office 365 license conversion. Group app assignments migrated: ${count_app_gaas}
app.office365.license.conversion.job.migration.users.v1.to.v0.failed = Migration of licenses from v1 to v0 for app users failed during Office 365 license conversion, received error: ${app_error_code}
...
app.office365.license.conversion.job.skipping.migration.user.v1.to.v0 = Skipping migration of licenses from v1 to v0 for app user during Office 365 license conversion, app user id: ${app_user_id}
app.office365.license.conversion.job.skipping.migration.gaa.v1.to.v0 = Skipping migration of licenses from v1 to v0 for group app assignment during Office 365 license conversion, group app assignment id: ${group_app_assignment_id}
...
app.office365.license.conversion.job.skipping.migration.gaa.v0.to.v1 = Skipping migration of licenses from v0 to v1 for group app assignment during Office 365 license conversion, group app assignment id: ${group_app_assignment_id}
app.office365.dirsync.skipping.critical-system-object = Skipping sync of critical system object: ${object}
app.office365.dirsync.skipping.conflict-object = Skipping sync of conflict object: ${object}
app.office365.dirsync.skipping.systemmailbox = Skipping sync of system mailbox object: ${object}
app.office365.dirsync.skipping.reserved-attribute-value = Skipping sync of object with reserved attribute value: ${object}
app.office365.dirsync.skipping.non-security-group-invalid-mail = Skipping sync of non security object with invalid mail: ${object}
app.office365.dirsync.skipping.without-name-and-displayname = Skipping sync of non security object without name and display name: ${object}

# Office365 Success Messages
app.office365.api.set.domain.federation.success = Successfully set up the domain federation with new settings: ${new_domain_federation_settings}
app.office365.api.change.domain.federation.success = Successfully updated the domain federation from old settings to new settings, old settings: ${old_domain_federation_settings}, new settings: ${new_domain_federation_settings}
app.office365.api.remove.domain.federation.success = Successfully removed the domain federation, domain: ${domain}
app.office365.api.set.wsfed.configure.type.success = Successfully updated the domain WS-Federation configuration type to ${wsfed_configure_type}

# RUM
app.rum.validation.error = Error during package validation: ${app_error_code}
app.rum.validation.failure = Remote User Management package validation failed: ${app_error_code}
app.rum.config.validation.error = Error validating instance configuration: ${app_error_code}
...
app.rum.failure.timeout.reschedule = Remote User Management call to ${app_error_code} returned a timeout and will be automatically rescheduled

#
# Dropbox
#
dropboxVerifyFailed=Could not connect to Dropbox API, please check your OAuth Token and Secret. ${app_error_code}
...
app.dropbox.api.error.set.user.permissions=Unable to set user permissions. ${app_error_code}
...
app.ad.api.user_import.warn.skipped_user.attribute_invalid_value=Skipping import of user '${distinguished_name}'. AD attribute: ${ad_attr_name}, (Okta attribute: ${okta_attr_name}) with the value of ${ad_attr_value} is invalid. Please consult with your Active Directory admin if you believe this user should be imported.
app.ad.api.user_import.warn.skipped_contact.attribute_invalid_value=Skipping import of contact '${distinguished_name}'. AD attribute: ${ad_attr_name}, (Okta attribute: ${okta_attr_name}) with the value of ${ad_attr_value} is invalid. Please consult with your Active Directory admin if you believe this contact should be imported.
...
# LDAP imports
app.ldap.group_import.warn.skipped_group.missing_required_attribute=Skipping import of group '${distinguished_name}'. Expected required attribute: ${attr_name}, (Okta attribute: ${okta_attr_name}) to not be null. Please consult with your ${app_name} admin if you believe this group should be imported.
...
app.ad.api.user_import.account_locked=Active Directory user account set to locked following profile update: user is locked in active directory.
...
app.ldap.agent.disconnected= LDAP agent ${agent_name} stopped connecting to Okta
app.ldap.agent.reconnected= LDAP agent ${agent_name} reconnected to Okta
...
test.type.test.subtype=This is a test message.
test.type.other.subtype=This is a different test message.
test.type.test.formatted=This is a test message in ${test_name}
...
platform.group_app_assignment.skip_assignment_reconcile=Skipped assignment reconcile for App ${instance_name} properties edited in group ${group_name}

# UD Inbound SAML Messages
core.user_auth.idp.saml.login_success=Sign-in successful for federated login via SAML Assertion [ID=${token_id}] with AMR [${saml_amr}]
core.user_auth.idp.saml.unknown_endpoint=Unable to resolve IdP endpoint with '${match_criteria}'. Ensure the IdP is correctly configured
core.user_auth.idp.saml.saml_validation_failed=Unable to validate incoming SAML Assertion: [${token_id}] - ${error_message}
core.user_auth.idp.username_transform_failed=Unable to transform incoming subject '${email}' to username - ${error_message}
core.user_auth.idp.username_filtered=The transformed username '${okta_username}' was rejected by the username filter.
core.user_auth.idp.no_matching_users=Unable to match transformed username '${okta_username}' to an existing Okta User.
core.user_auth.idp.multiple_matching_users=Unable to match transformed username '${okta_username}' to an existing Okta User because multiple Okta Users were found.
core.user_auth.idp.invalid_user_status=Unable to authenticate '${okta_username}' because the matched user has an invalid status (${user_status}).
core.user_auth.idp.saml.unknown_profile_attribute=Skipping assertion attributes ${attribute_name} because the IdP User Profile for incoming subject '${subject_name}' does not contain an attribute with a matching external name.
core.user_auth.idp.general_schema_warning=Skipping assertion attributes ${attribute_name} for incoming subject ${subject_name} for username ${okta_username} because of schema mismatch - ${error_message}
core.user_auth.idp.login_failed=Sign-in failed for federated login '${okta_username}' - ${reason_code}

# Used for legacy inbound saml endpoint only.
core.user_auth.saml2.inbound_saml_login_failed = Inbound SAML login failed with message: ${message}

# Social Auth Messages
core.user_auth.idp.social.login_success=Sign-in successful for federated login via Social Identity Provider
core.user_auth.idp.social.cannot_acquire_access_token=Unable to retrieve an access token for the Identity Provider due to error '${error_message}'
core.user_auth.idp.social.cannot_acquire_profile=Unable to retrieve a user profile from the Identity Provider due to error '${error_message}'
core.user_auth.idp.social.jit_callout_denied_by_callout=Account provisioning of incoming subject '${subject_name}' denied via external callout '${callout_url}'
core.user_auth.idp.social.jit_callout_success=Account provisioning of incoming subject '${subject_name}' as user '${okta_username}' approved via external callout '${callout_url}'
core.user_auth.idp.social.jit_callout_response_invalid=Unable to perform account provisioning of incoming subject '${subject_name}' due to an invalid response from external callout '${callout_url}'
core.user_auth.idp.social.link_callout_success=Account link of incoming subject '${subject_name}' to user '${okta_username}' approved via external callout '${callout_url}'
core.user_auth.idp.social.link_callout_denied_by_callout=Account link of incoming subject '${subject_name}' denied via external callout '${callout_url}'
core.user_auth.idp.social.link_callout_response_invalid=Unable to perform account link of incoming subject '${subject_name}' due to an invalid response from external callout '${callout_url}'
core.user_auth.idp.social.jit_callout_redirect=Account provisioning request for incoming subject '${subject_name}' redirected to external callout '${callout_url}' for approval
core.user_auth.idp.social.link_callout_redirect=Account link request for incoming subject '${subject_name}' redirected to external callout '${callout_url}' for approval

core.user_auth.idp.social.link_denied_for_groups=Account link of incoming subject '${subject_name}' to user '${okta_username}' denied due to group membership restriction '${groups}'

# Reason Codes for IDP Login Failure
auth.error_reason.jit_failed=Unable To JIT
auth.error_reason.unable_to_perform=Unable To Perform
auth.error_reason.request_time_out=Time Out
auth.error_reason.too_many_attempts=Too Many Attempts
auth.error_reason.user_not_found=User Not Found
auth.error_reason.user_denied=User Denied/Rejected
auth.error_reason.invalid_user_status=Invalid User Status
auth.error_reason.invalid_credential=Invalid Credential

# SAML Replay Attack
core.user_auth.idp.saml.response_received_in_response_to_no_matching_key=Unable to validate SAML Response [ID=${message_id}] - 'InResponseTo=${in_response_to}' does not match an ID of a SAML authentication request sent from Okta
core.user_auth.idp.saml.assertion_received_same_assertion_id=A SAML Assertion with the same ID [${token_id}] has already been processed by Okta for a previous request.
...
app.boxnet.api.error.update.group=Could not update group. ${app_error_code}
...
app.boxnet.api.error.rate_limit_exceeded=Rate limit exceeded for Box. ${app_error_code}

# netsuite messages
app.netsuite.api.error.auth=Failed to authenticate with NetSuite: ${app_error_code}
app.netsuite.api.error.check_user_exists=Failed to check if user exists on NetSuite: ${app_error_code}
app.netsuite.api.error.create_new_user=Failed to create user in NetSuite: ${app_error_code}
app.netsuite.api.error.deactivate_user=Failed to deactivate user in NetSuite: ${app_error_code}
app.netsuite.api.error.reactivate_user=Failed to reactivate user in NetSuite: ${app_error_code}
app.netsuite.api.error.import_user_profile=Failed to import user from NetSuite: ${app_error_code}
app.netsuite.api.error.download_custom_objects=Failed to download roles from NetSuite: ${app_error_code}
app.netsuite.api.error.download_users=Failed to download users from NetSuite: ${app_error_code}
app.netsuite.api.error.push_profile_update=Failed to push profile update for user to NetSuite: ${app_error_code}
app.netsuite.api.error.push_password_update=Failed to push password update for user in NetSuite: ${app_error_code}
...
app.api.error.user.not_found_or_deleted=User was not found because user may have been deleted in the application: ${app_error_code}
...
app.api.error.download_app_schema=Error while downloading app schemas: ${app_error_code}
...
app.ldap.password.change.failed=Password change failed.
...
app.samanage.api.error.incorrect.attribute=User has incorrect attribute(s): ${app_error_code}
app.api.error.manager.not_found_for_user=Failed to push reportsTo app user attribute for ${app_error_code} to SAManage
...
app.litmos.import.rate_limit_exceeded = ${app_error_code}
...
#  Okta org
#
app.okta_org.user_management.error.download_app_schema=Error occured while downloading app schema
app.okta_org.user_management.error.download_user_type=Error occured while downloading user type
app.okta_org.user_management.error.parse_schema=Error occured while parsing user app schema
app.okta_org.user_management.error.schema.property.not.exist=Json field={0} does not exist for object={1}

#
# Facebook at work
#
app.facebook_at_work.error.manager_not_found_in_facebook=Manager with email ${app_error_code} does not exist in Facebook At Work and will not be set for this user.


#
# Single Logout
#
app.auth.slo.saml.invalid_signature=Unable to validate SAML Logout Request: [${request_id}] - Request has an invalid signature.
app.auth.slo.saml.invalid_issuer=Unable to validate SAML Logout Request: [${request_id}] - Issuer [${saml_request_issuer}] does not match the Issuer configured for the application.
app.auth.slo.saml.invalid_nameid=Unable to validate SAML Logout Request: [${request_id}] - NameID [${saml_request_nameid}] does not match the logged on user for the application.
app.auth.slo.saml.malformed_request=Unable to process SAML Logout Request - The request is malformed and could not be parsed.
app.auth.slo.saml.malformed_request.invalid_type=Unable to process SAML Logout Request - The message type [${saml_request_qname}] is not valid for a logout request.
app.auth.slo=User performed single logout from app.
app.auth.slo.with_reason=User performed single logout from app with reason specified [${reason}].

#
# BambooHR app
#
bamboohr.api.error.download_app_schema=Error while downloading application schema: ${app_error_code}

#
# OpenID Connect
#
app.oauth2.signon_success=User performed single sign on to app. SSO is of type: OIDC with initiation type: ${initiate_type}, client_id: ${client_id}
app.oauth2.signon_failure=User failed to perform single sign on to app due to ${app_error_code}. SSO is of type: OIDC with initiation type: ${initiate_type}, client_id: ${client_id}
app.oauth2.authorize.code_success=Authorization code ${code} successfully granted to client ${client_id} for scopes [${scopes}] via redirect URI ${redirect_uri}
app.oauth2.authorize.implicit_success=Successfully issued tokens ${id_token} ${access_token} via implicit flow to client ${client_id} for scopes [${scopes}] via redirect URI '${redirect_uri}'
app.oauth2.authorize_failure=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.access_denied=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.invalid_client_id=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.invalid_cache_key=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.no_existing_session=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.login_failed=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.mismatched_user_in_cache_and_session=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.authorize.user_not_assigned=Authorization request for ${response_type} rejected for client ${client_id}, scopes [${scopes}] and redirect URI ${redirect_uri} due to reason: ${app_error_code}
app.oauth2.token.grant.id_token_success=Successfully issued ${id_token} via grant type ${grant_type} for client ${client_id} with authentication type ${client_auth_type} and scopes [${scopes}]
app.oauth2.token.grant.access_token_success=Successfully issued ${access_token} via grant type ${grant_type} for client ${client_id} with authentication type ${client_auth_type} and scopes [${scopes}]
app.oauth2.token.grant.refresh_token_success=Successfully issued ${refresh_token} via grant type ${grant_type} for client ${client_id} with authentication type ${client_auth_type} and scopes [${scopes}]
app.oauth2.token.grant_failure=Token request for ${grant_type}-${code} ${refresh_token} rejected for client ${client_id}' with authentication type ${client_auth_type} and scopes [${scopes}] due to reason: ${app_error_code}
...
user.authentication.slo=User single sign out from app
...
system.agent.ad.import_toplogy=Perform import topology by AD agent
system.agent.ad.read_schema=Perform schema read by AD agent
system.agent.ad.scan=Perform import by AD agent
...
# Connector Agent
#
agents.agent.connector.agent_reconnected=Agent ${agent_id} (${agent_name}) reconnected to Okta
agents.agent.connector.agent_disconnected=Agent ${agent_id} (${agent_name}) stopped connecting to Okta
agents.agent.connector.agent_deactivated=Agent ${agent_id} (${agent_name}) deactivated
agents.agent.connector.agent_reactivated=Agent ${agent_id} (${agent_name}) reactivated
agents.agent.connector.agent_deleted=Agent ${agent_id} (${agent_name}) deleted
agents.agent.connector.agent_reactivate_failed_missing_token=Cannot reactivate the agent ${agent_id} (${agent_name}) because the token has been removed. You must delete and re-install the agent.
...
user.session.start_api_token=Session created using api token
user.session.start_api_access_denied=Access denied due to sign on policy
user.session.clear=Clear user session
user.session.expire=Expire user session

#
# Session Impersonation
#  https://oktawiki.atlassian.net/wiki/display/PM/Impersonation+Events
#
...
user.mfa.factor.activate=Activate factor for user
...
# Account
#
user.account.access_super_user_app=Access super user in Okta
user.account.lock=Auto-lock user account for Okta
user.account.privilege.grant=Grant user privilege
user.account.privilege.revoke=Revoke user privilege
...
user.account.lock_max_sign_in=Max sign in attempts exceeded
...
# SMS
#
system.sms.send_account_unlock_message=Send self-service account unlock SMS message
system.sms.send_factor_verify_message=Send second factor auth SMS
system.sms.send_okta_push_verify_message=Send activate Okta Verify Push for mobile SMS
system.sms.send_password_reset_message=Send self-service password reset SMS message
system.sms.send_phone_verification_message=Send phone verification SMS message
...
# CVD
#
group.user_membership.rule.add_exclusion=Add user to group membership exclusion rule
group.user_membership.rule.invalidate=Invalidate group membership rule
group.user_membership.rule.trigger=Trigger group membership rule
directory.app_user_profile.bootstrap=Bootstrap application user profile
directory.app_user_profile.update=Update application user profile
directory.mapping.update=Update universal directory mappings
directory.user_profile.bootstrap=Bootstrap universal directory user profile
directory.user_profile.update=Update universal directory user profile	directory.user_profile.update
...
group.application_assignment.update=Update assigned application in group

#
# Application membership
#
application.user_membership.change_username=Change user's application username
...
application.user_membership.change_password=Change application password for user

#
# Provisioning
#
application.provision.user.activate=Activate user's application membership
application.provision.user.deactivate=Push user deactivation to external application
application.provision.user.deprovision=Deprovision user from external application
application.provision.user.push=Push new user to external application
application.provision.user.push_okta_password=Push user's Okta password to application
application.provision.user.push_password=Push user's password to application
...
#
application.configuration.detect_error=Application configuration error detected
application.configuration.disable_delauth_outbound=Disable delegated authentication for app
application.configuration.enable_delauth_outbound=Enable delegated authentication for app
application.configuration.reset_logo=Reset app logo
application.configuration.update_api_credentials_for_pass_change=Update API credentials due to user updating password
application.configuration.update_logo=Change app logo

#
# Application Policy
#
application.policy.sign_on.deny_access=Deny user access due to app sign on policy
application.policy.sign_on.rule.create=Create rule for app sign on policy
application.policy.sign_on.rule.delete=Delete rule from app sign on policy
application.policy.sign_on.update=Update app sign on policy
