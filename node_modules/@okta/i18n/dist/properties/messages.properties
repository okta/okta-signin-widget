...
sms.template.type.string.is.too.long            = The custom sms template type is too long.
sms.template.name.string.is.too.long            = The custom sms template name is too long.
sms.template.string.is.too.long                 = The custom sms template content is too long.
sms.template.too.many.translations              = Too many translations for a custom sms template.
sms.template.translation.language.string.is.too.long = The language is too long for a translation in custom sms template.
unexpected.language.in.custom.sms.template.translation = The language is invalid for a translation in custom sms template.
sms.template.translation.template.string.is.too.long = The translation content for a custom sms template is too long.
missing.code.variable.in.custom.sms.template.translations = Missing the required ${code} variable in the custom template translation.
invalid.empty.custom.sms.template.language      = The language is empty for a translation in custom sms template.
invalid.empty.custom.sms.template.type          = Invalid empty custom sms template type.
invalid.empty.custom.sms.template.name          = Invalid empty custom sms template name.
...
app.ad.import_config.customLdapFilterError=Invalid ldap filter: {0}
...
core.ratelimit.unsupportedurlpattern=Currently user rate limiting is supported only for '/api/v1/authn' endpoint.
...
platform.expression.use.new.expression.lang = Please use the SpEL expression syntax to write expressions.
...
platform.cvd.profiles.mapping.pushStatusError.exclude.userName.enabled=EXCLUDE_USERNAME_UPDATE_ON_PROFILE_PUSH is enabled and userName cannot be pushed on update.
platform.cvd.profiles.mapping.pushStatusError.profile.push.enabled=PUSH_PROFILE_UPDATES is off and userName cannot be pushed on update.
...
ommEnroll.policy.wizard.rule.form.maxAttempts.tooltip=The number of failed sign in attempts allowed before the device is erased. The number must be between 1 and 10, or enter 0 for unlimited attempts.
...
ommEnroll.policy.wizard.rule.form.lockTiming.header=LOCK TIMING
ommEnroll.policy.wizard.rule.form.iOS.displayTimeout.label=Turn display off
ommEnroll.policy.wizard.rule.form.iOS.displayTimeout.tooltip=This is also called "auto-lock" on iOS devices.
ommEnroll.policy.wizard.rule.form.iOS.passcodeGracePeriod.label=Then require passcode
ommEnroll.policy.wizard.rule.form.android.timeToLock.label=Require passcode
ommEnroll.policy.wizard.rule.form.android.timeToLock.tooltip=On Android devices you set the overall time from last user activity to a passcode being required. The user controls when the display is turned off.
ommEnroll.policy.wizard.rule.form.option.displayTimeout.oneMinute=1 minute after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.twoMinutes=2 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.threeMinutes=3 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.fourMinutes=4 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.fiveMinutes=5 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.tenMinutes=10 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.fifteenMinutes=15 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.twentyMinutes=20 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.twentyFiveMinutes=25 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.thirtyMinutes=30 minutes after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.oneHour=1 hour after last user activity
ommEnroll.policy.wizard.rule.form.option.displayTimeout.never=Never
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.immediately=Immediately
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.oneMinute=1 minute after display is turned off
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.fiveMinutes=5 minutes after display is turned off
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.fifteenMinutes=15 minutes after display is turned off
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.oneHour=1 hour after display is turned off
ommEnroll.policy.wizard.rule.form.option.passcodeGracePeriod.fourHours=4 hours after display is turned off
...
app.zendesk.api.error.validation.error=Failed to import user {0}, unsupported symbol in field {1} = {2}
...
app.workday.api.get-custom-report-data-empty = The custom report data fetched for externalId: {0} is empty.
...
policy.readonly.skipUnlock = The delegation.options.skipUnlock property cannot be set to true when the Authentication Provider is set to {0}.
policy.readonly.skipUnlock.no.softlock = The delegation.options.skipUnlock property cannot be set to true unless the PASSWORD_POLICY_SOFT_LOCK feature is enabled.
...
# client certificate
certificate.error.not_self_signed=The certificate was not accepted because it is not self signed.
certificate.upload.error=There was an error reading certificate file that was uploaded.  Check the file and try again.
...
idp.config.oauth.idToken=OpenID Connect ID Token
idp.config.oauth.idToken.description=Claims for this token include all user attributes on the app profile.

idp.config.oauth.claims=Claims
idp.config.oauth.claims.groupClaim=Groups claim
idp.config.oauth.claims.groupClaim.helpText=This claim contains a list of the user's groups. The first field is the claim name that will be used in the token. The second field sets a filter for the list of groups.
idp.config.oauth.claims.groupClaim.startsWith=Starts with
idp.config.oauth.claims.groupClaim.equals=Equals
idp.config.oauth.claims.groupClaim.contains=Contains
idp.config.oauth.claims.groupClaim.regex=Regex
idp.config.oauth.claims.none=None

idp.config.oauth.accessToken=OAuth 2.0 Access Token
idp.config.oauth.accessToken.scopes.description=Default scopes include: openid, profile, email, address, phone.
idp.config.oauth.accessToken.scopes.add=Add scope
idp.config.oauth.accessToken.claims.add=Add claim
idp.config.oauth.accessToken.claims.name.description=Claim name
idp.config.oauth.accessToken.claims.value.description=Claim value
...
idp.error.invalid_scopes=Scopes cannot contain HTML tags.
...
idp.error.code.invalid_scope=The requested scope is invalid, unknown, malformed, or exceeds the scope granted by the resource owner.
...
idp.error.code.client_credentials_in_query=Client credentials cannot be supplied via query parameters.
idp.error.code.invalid_client_id=Invalid value for 'client_id' parameter.
idp.error.code.invalid_token_endpoint_auth_method=The token_endpoint_auth_method is invalid.
idp.error.code.invalid_client_secret=The client secret supplied for a confidential client is invalid.
...
idp.error.code.token_request_missing_grant_type=Token request missing grant_type.
idp.error.code.token_request_missing_device_id=Token request missing device_id.
idp.error.code.invalid_authorization_code=The authorization code is invalid.
idp.error.code.mismatched_client=The grant was issued to another client.
idp.error.code.mismatched_redirect_uri=The redirect_uri does not match the redirection URI used in the authorization request.
idp.error.code.invalid_refresh_token=The refresh token is invalid.
idp.error.code.password_auth_denied_mfa=Resource owner credentials cannot be used with MFA enabled.
idp.error.code.password_auth_denied_policy=Resource owner credentials authentication denied by policy.
idp.error.code.request_missing_token=The token parameter is required.
# UserInfo
...
#
appinstance.username.pushstatus.label=Update application username on
appinstance.pushstate.create.and.update=Create and update
appinstance.pushstate.create.only=Create only
...
#
app.inventory.view.list.no.application.show=No applications to show
app.inventory.view.list.no.application.found=No applications found
app.inventory.view.list.coulumns.application=Application
app.inventory.view.list.coulumns.version=Version
app.inventory.view.list.coulumns.count=Device Count
app.inventory.view.list.buttons.download=Download CSV
app.inventory.view.message.text=Please enable Application Reporting to view application data for enrolled OS X devices.
app.inventory.view.message.button=Enable Application Reporting
app.inventory.view.header.label=Application Reporting
app.inventory.view.header.tooltip=It may take up to 24 hours for devices to report installed applications.
app.inventory.view.dropdown.enabled=Enabled
app.inventory.view.dropdown.disabled=Disabled
app.inventory.device-details.tabs.info=Device Info
app.inventory.device-details.tabs.app=Installed Applications
...
universal-directory.profiles.attribute.delete.failure=Unable to delete attribute {0}
...
universal-directory.profiles.attribute.save.success=Attribute {0} saved
universal-directory.profiles.attribute.details.between=Between
universal-directory.profiles.attribute.details.greaterThan=Greater than
universal-directory.profiles.attribute.details.lessThan=Less than
universal-directory.profiles.attribute.details.equals=Equals
universal-directory.profiles.attribute.details.placeholderText.min=min
universal-directory.profiles.attribute.details.placeholderText.max=max
universal-directory.profiles.attribute.details.placeholderText.value=value
universal-directory.profiles.attribute.details.constraintText.and=and
...
policies.mobile.afw.title=Step {0}: {1}

policies.mobile.afw.selectDomain.title=Select the Google Apps Instance
policies.mobile.afw.selectDomain.instance.label=Use this Google Apps domain
...
policies.mobile.afw.register.error.required=Your company\'s domain and Google token are required
...
policies.mobile.afw.oktaProvision.info=Each user needs a Google account in order to enroll in Android for Work. Choose how the Google accounts should be created below.
...
policies.mobile.afw.authenticate.info=Your users need to authenticate with Google when they enroll in Android for Work. Choose an authentication method below.
...
policies.mobile.afw.oktaMobile.title=Approve Okta Mobile\'s permissions
policies.mobile.afw.oktaMobile.info=You need to approve Okta Mobile\'s permissions. This lets your users automatically get updates to Okta Mobile.
policies.mobile.afw.oktaMobile.approvePermission.label=Approve permissions
policies.mobile.afw.oktaMobile.approvePermission.option=I approve Okta Mobile\'s permissions (Required)
policies.mobile.afw.oktaMobile.approvePermission.hide=Hide permissions
policies.mobile.afw.oktaMobile.approvePermission.show=See permissions
policies.mobile.afw.oktaMobile.approvePermission.error=Approving Okta Mobile\'s permissions is required
