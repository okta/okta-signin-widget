...
FM = Micronesia, Negara Persekutuan
FO = Kepulauan Faroe
FR = Perancis
GA = Gabon
GB = United Kingdom
...
IL = Israel
IN = India
IO = Wilayah Lautan Hindia British
IQ = Iraq
...
MK = Macedonia, bekas Republik Yugoslav
ML = Mali
MM = Myanmar
MN = Mongolia
MO = Macao
...
UA = Ukraine
UG = Uganda
UM = Kepulauan Kecil Terpencil Amerika Syarikat
US = Amerika Syarikat
UY = Uruguay
UZ = Uzbekistan
VA = Holy See (Negara Kota Vatican)
