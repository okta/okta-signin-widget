...
test
  .requestHooks(loopbackSuccessLogger, loopbackSuccesskMock)
  (`in loopback server approach, probing and polling requests are sent and responded`, async t => {
...
test
  .requestHooks(loopbackFallbackLogger, loopbackFallbackMock)
