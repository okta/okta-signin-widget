...
import xhrAuthenticatorEnrollPhoneWithWarning from '../../../playground/mocks/data/idp/idx/authenticator-enroll-phone-with-warning';
import xhrAuthenticatorEnrollPhoneVoiceWithWarning from '../../../playground/mocks/data/idp/idx/authenticator-enroll-phone-voice-with-warning';
...
const smsMockWithWarning = RequestMock()
  .onRequestTo('http://localhost:3000/idp/idx/introspect')
  .respond(xhrAuthenticatorEnrollPhoneWithWarning)
  .onRequestTo('http://localhost:3000/idp/idx/challenge/answer')
  .respond(xhrSuccess);  
...
const voiceMockWithWarning = RequestMock()
  .onRequestTo('http://localhost:3000/idp/idx/introspect')
  .respond(xhrAuthenticatorEnrollPhoneVoiceWithWarning)
  .onRequestTo('http://localhost:3000/idp/idx/challenge/answer')
  .respond(xhrSuccess);
...
test
  .requestHooks(smsMockWithWarning)('Callout appears in sms mode', async t => {
    const challengePhonePageObject = await setup(t);
...
test
  .requestHooks(voiceMockWithWarning)('Callout appears in voice mode', async t => {
    const challengePhonePageObject = await setup(t);
    await t.expect(challengePhonePageObject.resendEmailView().hasClass('hide')).notOk();
    const resendEmailView = challengePhonePageObject.resendEmailView();
