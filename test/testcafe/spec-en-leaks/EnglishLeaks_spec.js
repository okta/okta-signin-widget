...
const ignoredMocks = [
  ...
  'mdm-enrollment.json', //Regression that must be fixed- will be fixed on OKTA-435413
  'oda-enrollment-android.json', //Regression that must be fixed - will be fixed on OKTA-435413
];
