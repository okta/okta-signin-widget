define({
    ...
    "response": {
        ...
        "_links": {
            ...
            "recoverLogin": {
                "href": "http://rain.okta1.com:1802/api/v1/authn/recoverLogin",
                "hints": {
                    "allow": [
                        "POST"
                    ]
            ...
            "enroll": {
                "href": "http://rain.okta1.com:1802/api/v1/authn/enroll",
                "hints": {
                    "allow": [
                        "POST"
                    ]
            ...
            "login": {
                "href": "http://rain.okta1.com:1802/api/v1/authn/login",
                "hints": {
                    "allow": [
                        "POST"
                    ]
