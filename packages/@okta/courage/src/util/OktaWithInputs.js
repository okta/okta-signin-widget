...
function (Okta, TextBox, TextArea, Select, Radio, CheckBox, TextSelect, TextPlusSelect, DateBox, NumberBox,
          ...
          UniqueSelect, BaseInput, BasePicker, BaseSelectize, BaseFileUploader, GroupSelect, ScopesPicker, IdpPicker,
          DateTimePicker, CheckBoxSet, TextBoxSet, BooleanSelect, DeletableBox) {
  ...
  registerInput('password', TextBox, 'TextBox');
