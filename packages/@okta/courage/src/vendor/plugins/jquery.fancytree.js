  ...
  //					node.children[0].setFocus();
    ...
    nodeLoadChildren: function(ctx, source) {
      ...
      if(source.url){
        ...
        source = source.then(function (data, textStatus, jqXHR) {
  ...
  //				alert("remove child markup for " + node);
    ...
    nodeRenderTitle: function(ctx, title) {
      ...
      if ( icon && typeof icon === "string" ) {
        ...
        ares.push("<span " + role + " class='fancytree-icon fancytree-expander'></span>");
      }
      else{
        ares.push("<span " + role + " class='fancytree-icon fancytree-expander12'></span>");
      }
      // node title
      nodeTitle = "";
