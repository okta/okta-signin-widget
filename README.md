...
- [API](#api)
  - [new OktaSignIn(config)](#new-oktasigninconfig)
  - [renderEl(options, success, error)](#rendereloptions-success-error)
  - [`OIDC` showSignInToGetTokens(options)](#oidc-showsignintogettokensoptions)
  - [hide](#hide)
  - [show](#show)
  - [remove](#remove)
  - [on(event, callback[, context])](#onevent-callback-context)
  - [off([event, callback])](#offevent-callback)
  - [getTransaction(stateToken)](#gettransactionstatetoken)
  - [session.get(callback)](#sessiongetcallback)
  - [session.refresh(callback)](#sessionrefreshcallback)
  - [session.close(callback)](#sessionclosecallback)
  - [`OIDC` token.hasTokensInUrl()](#oidc-tokenhastokensinurl)
  - [`OIDC` token.parseTokensFromUrl(success, error)](#oidc-tokenparsetokensfromurlsuccess-error)
  - [`OIDC` tokenManager.add(key, token)](#oidc-tokenmanageraddkey-token)
  - [`OIDC` tokenManager.get(key)](#oidc-tokenmanagergetkey)
  - [`OIDC` tokenManager.remove(key)](#oidc-tokenmanagerremovekey)
  - [`OIDC` tokenManager.clear()](#oidc-tokenmanagerclear)
  - [`OIDC` tokenManager.refresh(key)](#oidc-tokenmanagerrefreshkey)
  - [`OIDC` tokenManager.on(event, callback[, context])](#oidc-tokenmanageronevent-callback-context)
  - [`OIDC` tokenManager.off(event[, callback])](#oidc-tokenmanageroffevent-callback)
- [Configuration](#configuration)
  ...
  - [Registration](#registration)
      ...
      - [Use form level error](#use-form-level-error)
      - [Use field level error](#use-field-level-error)
  - [IdP Discovery](#idp-discovery)
    - [Additional configuration](#additional-configuration)
    - [Additions in the success callback](#additions-in-the-success-callback)
