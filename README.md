...
- **idps:** External Identity Providers to use in OIDC authentication. Supported IDPs ( `GOOGLE`, `FACEBOOK`, and `LINKEDIN` ) will get distinct styling and default i18n text, while any other type will receive a general styling and require text to be provided.
    ...
    idps: [
      ...
      {type: 'Joe IDP', id: '0oabds23xM3ssMjosl0g5', text: 'Login with Joe'}      
    ]
    ```
