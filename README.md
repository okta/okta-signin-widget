...
- **brandName:** The brand name that is displayed in the various descriptions of the Sign In Widget (example: "Signing in to {`brandName`}..."). If no number is provided, no brand name is shown to the user (example: "Signing in...").
