...
/* eslint max-params: 0 */
import AccountUnlockedController from './controllers/AccountUnlockedController';
import ActivateTotpController from './controllers/ActivateTotpController';
import AdminConsentRequiredController from './controllers/AdminConsentRequiredController';
import BarcodePushController from './controllers/BarcodePushController';
import BarcodeTotpController from './controllers/BarcodeTotpController';
import ConsentRequiredController from './controllers/ConsentRequiredController';
import CustomPasswordExpiredController from './controllers/CustomPasswordExpiredController';
import DeviceActivateController from './controllers/DeviceActivateController';
import DeviceActivateTerminalController from './controllers/DeviceActivateTerminalController';
import EnrollActivateCustomFactorController from './controllers/EnrollActivateCustomFactorController';
import EnrollActivateEmailController from './controllers/EnrollActivateEmailController';
import EnrollCallAndSmsController from './controllers/EnrollCallAndSmsController';
import EnrollChoicesController from './controllers/EnrollChoicesController';
import EnrollCustomFactorController from './controllers/EnrollCustomFactorController';
import EnrollDuoController from './controllers/EnrollDuoController';
import EnrollEmailController from './controllers/EnrollEmailController';
import EnrollHotpController from './controllers/EnrollHotpController';
import EnrollOnPremController from './controllers/EnrollOnPremController';
import EnrollPasswordController from './controllers/EnrollPasswordController';
import EnrollQuestionController from './controllers/EnrollQuestionController';
import EnrollSymantecVipController from './controllers/EnrollSymantecVipController';
import EnrollTotpController from './controllers/EnrollTotpController';
import EnrollU2FController from './controllers/EnrollU2FController';
import EnrollUserController from './controllers/EnrollUserController';
import EnrollWebauthnController from './controllers/EnrollWebauthnController';
import EnrollWindowsHelloController from './controllers/EnrollWindowsHelloController';
import EnrollYubikeyController from './controllers/EnrollYubikeyController';
import EnrollmentLinkSentController from './controllers/EnrollmentLinkSentController';
import EnterPasscodePushFlowController from './controllers/EnterPasscodePushFlowController';
import ForgotPasswordController from './controllers/ForgotPasswordController';
import IDPDiscoveryController from './controllers/IDPDiscoveryController';
import ForceIDPDiscoveryController from './controllers/ForceIDPDiscoveryController';
import ManualSetupPushController from './controllers/ManualSetupPushController';
import ManualSetupTotpController from './controllers/ManualSetupTotpController';
import MfaVerifyController from './controllers/MfaVerifyController';
import PasswordExpiredController from './controllers/PasswordExpiredController';
import PasswordResetController from './controllers/PasswordResetController';
import PollController from './controllers/PollController';
import PrimaryAuthController from './controllers/PrimaryAuthController';
import PwdResetEmailSentController from './controllers/PwdResetEmailSentController';
import RecoveryChallengeController from './controllers/RecoveryChallengeController';
import RecoveryLoadingController from './controllers/RecoveryLoadingController';
import RecoveryQuestionController from './controllers/RecoveryQuestionController';
import RefreshAuthStateController from './controllers/RefreshAuthStateController';
import RegistrationCompleteController from './controllers/RegistrationCompleteController';
import RegistrationController from './controllers/RegistrationController';
import UnlockAccountController from './controllers/UnlockAccountController';
import UnlockEmailSentController from './controllers/UnlockEmailSentController';
import VerifyCustomFactorController from './controllers/VerifyCustomFactorController';
import VerifyDuoController from './controllers/VerifyDuoController';
import VerifyPIVController from './controllers/VerifyPIVController';
import VerifyU2FController from './controllers/VerifyU2FController';
import VerifyWebauthnController from './controllers/VerifyWebauthnController';
import VerifyWindowsHelloController from './controllers/VerifyWindowsHelloController';
import ErrorStateController from './controllers/ErrorStateController';
