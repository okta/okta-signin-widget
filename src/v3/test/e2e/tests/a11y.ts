...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/default',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/securityquestion-verify',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/sms-challenge',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/sms-method',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/default',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/error-401-invalid-otp-passcode',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/google-auth-verify',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-email',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/email-challenge-consent',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/webauthn-enroll-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/enroll/default',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/oauth2/default/v1/interact/error-feature-not-enabled',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-okta-verify-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-ov-email-channel',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-ov-sms-channel',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-ov-qr-version-upgrade',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/enroll/new/error-account-creation',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/oauth2/default/v1/interact/error-recovery-token-invalid',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/oauth2/default/v1/interact/error-400-unauthorized-client',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-email-error',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-full-location-enrollment',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-full-location-recovery',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-full-location-unlock',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-full-location',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-no-location',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/introspect/terminal-return-otp-only-partial-location',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/securityquestion-enroll-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/authenticator-expired-password',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/authenticator-expiry-warning-password',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/authenticator-expired-password-with-enrollment-authenticator',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/authenticator-expired-password-no-complexity',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/unlock-account/default',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/answer/unlock-account-success',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/verify-ov-code-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/verify-ov-push-method',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/verify-ov-send-push',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/verify-ov-push-manual',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/authenticator-enroll-select-authenticator',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/authenticator-enroll-select-authenticator-with-skip',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/authenticator-verification-select-authenticator',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/google-auth-scan-enroll',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-phone-voice-sms-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-phone-sms-code-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/credential/enroll/enroll-phone-voice-code-mfa',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/identify/password-reset',
...
test.page(
  'http://localhost:8080/?siw-use-mocks=true&siw-mock-response=/idp/idx/challenge/answer/password-reset',
