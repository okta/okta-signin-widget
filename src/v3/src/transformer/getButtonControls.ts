...
export const getButtonControls = (
  ...
  if (config.verifyWithOther) {
    properties[ButtonOptionType.CHANGE_AUTHENTICATOR] = {
      type: 'string',
    };
    ...
    elements.push({
      ...
      options: {
        ...
        variant: 'clear',
        idxMethod: 'proceed',
        idxStep: IDX_STEP.SELECT_AUTHENTICATOR_AUTHENTICATE,
        skipValidation: true,
      },
    } as ControlElement);
  }

  if (config.backToAuthList) {
    properties[ButtonOptionType.CHANGE_AUTHENTICATOR] = {
      type: 'string',
    };
    ...
    elements.push({
      ...
      options: {
        ...
        variant: 'clear',
        idxMethod: 'proceed',
        idxStep: IDX_STEP.SELECT_AUTHENTICATOR_ENROLL,
        skipValidation: true,
      },
    } as ControlElement);
  }
