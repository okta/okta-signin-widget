...
describe('TransformOktaVerifyChannelSelection Tests', () => {
  ...
  it('should only append (sms/email) channel options when on mobile and qrcode is the selectedChannel', () => {
    ...
    const updatedFormBag = transformOktaVerifyChannelSelection(transaction, formBag);
    ...
    expect(updatedFormBag.uischema.elements[3].options?.skipValidation).toBeTruthy();
  });
