...
jest.mock('./createIdentifierContainers', () => ({
...
const mocked = {
  ...
  createIdentifierContainers: require('./createIdentifierContainers'),
};
...
describe('UISchema transformer', () => {
  it('follows transformation steps', () => {
    ...
    jest.spyOn(mocked.createIdentifierContainers, 'createIdentifierContainers');
    ...
    expect(mocked.createIdentifierContainers.createIdentifierContainers).toHaveBeenCalled();
  });
});
