...
describe('"required" field transformer', () => {
  it('should add formfield name to JSONForm schema required array if "required" prop equals "true" in formfield', () => {
    const formfield: Input = { name: 'testField', required: true };
