...
export const EMAIL_AUTHENTICATOR_TERMINAL_KEYS = [
  TERMINAL_KEYS.EMAIL_LINK_CANT_BE_PROCESSED,
  TERMINAL_KEYS.EMAIL_LINK_OUT_OF_DATE,
  TERMINAL_KEYS.EMAIL_VERIFICATION_REQUIRED,
  TERMINAL_KEYS.FLOW_CONTINUE_IN_NEW_TAB,
  TERMINAL_KEYS.IDX_RETURN_LINK_OTP_ONLY,
  TERMINAL_KEYS.OPERATION_CANCELED_BY_USER_KEY,
  TERMINAL_KEYS.OPERATION_CANCELED_ON_OTHER_DEVICE_KEY,
  TERMINAL_KEYS.RETURN_LINK_EXPIRED_KEY,
  TERMINAL_KEYS.RETURN_TO_ORIGINAL_TAB_KEY,
];

export const DEVICE_CODE_ERROR_KEYS = [
  TERMINAL_KEYS.DEVICE_NOT_ACTIVATED_CONSENT_DENIED,
  TERMINAL_KEYS.DEVICE_NOT_ACTIVATED_INTERNAL_ERROR,
];

export const TERMINAL_KEYS_WITHOUT_CANCEL = [
  TERMINAL_KEYS.DEVICE_ACTIVATED,
  ...DEVICE_CODE_ERROR_KEYS,
  TERMINAL_KEYS.FLOW_CONTINUE_IN_NEW_TAB,
  TERMINAL_KEYS.IDX_RETURN_LINK_OTP_ONLY,
  TERMINAL_KEYS.OPERATION_CANCELED_ON_OTHER_DEVICE_KEY,
  TERMINAL_KEYS.RESET_PASSWORD_NOT_ALLOWED_KEY,
  TERMINAL_KEYS.RETURN_TO_ORIGINAL_TAB_KEY,
  TERMINAL_KEYS.UNLOCK_ACCOUNT_FAILED_PERMISSIONS_KEY,
  TERMINAL_KEYS.UNLOCK_ACCOUNT_KEY,
];

export const TERMINAL_TITLE_KEYS = {
  [TERMINAL_KEYS.DEVICE_ACTIVATED]: 'device.code.activated.success.title',
  [TERMINAL_KEYS.DEVICE_NOT_ACTIVATED_CONSENT_DENIED]: 'device.code.activated.error.title',
  [TERMINAL_KEYS.DEVICE_NOT_ACTIVATED_INTERNAL_ERROR]: 'device.code.activated.error.title',
  [TERMINAL_KEYS.EMAIL_ACTIVATION_EMAIL_EXPIRE]: 'oie.activation.request.email.title.expire',
  [TERMINAL_KEYS.EMAIL_ACTIVATION_EMAIL_INVALID]: 'oie.activation.request.email.title.invalid',
  [TERMINAL_KEYS.EMAIL_ACTIVATION_EMAIL_SUBMITTED]: 'oie.activation.request.email.title.submitted',
  [TERMINAL_KEYS.EMAIL_ACTIVATION_EMAIL_SUSPENDED]: 'oie.activation.request.email.title.suspended',
  [TERMINAL_KEYS.FORGOT_PASSWORD_NOT_ENABLED]: 'password.reset.title.generic',
  [TERMINAL_KEYS.IDX_RETURN_LINK_OTP_ONLY]: 'idx.return.link.otponly.your.verification.code',
  [TERMINAL_KEYS.REGISTRATION_NOT_ENABLED]: 'oie.registration.form.title',
  [TERMINAL_KEYS.RETURN_LINK_EXPIRED_KEY]: 'oie.email.return.link.expired.title',
  [TERMINAL_KEYS.RETURN_TO_ORIGINAL_TAB_KEY]: 'oie.consent.enduser.email.allow.title',
  [TERMINAL_KEYS.UNLOCK_ACCOUNT_KEY]: 'account.unlock.unlocked.title',
};
