...
const Body = EnrollAuthenticatorDuressPasswordView.prototype.Body.extend({
  ...
  showMessages() {
    ...
    EnrollAuthenticatorDuressPasswordView.prototype.Body.prototype.showMessages.apply(this, arguments);
  },
});
...
export default EnrollAuthenticatorDuressPasswordView.extend({ Body, Footer });
