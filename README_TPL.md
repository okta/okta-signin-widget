...
```html
<!-- Latest CDN production Javascript and CSS: {{version}} -->
<script
  src="https://ok1static.oktacdn.com/assets/js/sdk/okta-signin-widget/{{version}}/js/okta-sign-in.min.js"
  type="text/javascript"></script>
<link
  href="https://ok1static.oktacdn.com/assets/js/sdk/okta-signin-widget/{{version}}/css/okta-sign-in.min.css"
  type="text/css"
  rel="stylesheet"/>

<!-- Theme file: Customize or replace this file if you want to override our default styles -->
<link
  href="https://ok1static.oktacdn.com/assets/js/sdk/okta-signin-widget/{{version}}/css/okta-theme.css"
  type="text/css"
  rel="stylesheet"/>
```
