...
const idx = {
  ...
  "/oauth2/default/v1/token": ["error-token-invalid-grant-pkce"],
  ...
  "/idp/idx/cancel": ["identify"],
  "/idp/idx/recover": ["error-forgot-password", "authenticator-reset-password"],
  "/idp/idx/activate": [
    "identify-with-password",
...
const authn = {
  ...
  "/.well-known/webfinger": ["forced-idp-discovery-okta-idp"],
};

//enroll QR Okta Verify
const enrollQROktaVerify = {
  "/api/v1/authn": ["mfa-enroll-qr-okta-verify"],
};

const enrollOVManually = {
  "/api/v1/authn": ["mfa-enroll-ov-manual"],
  "/idp/idx/activate/poll": ["identify-with-device-launch-authenticator"],
};

// email enroll
const emailEnrollMocks = {
  "/api/v1/authn": ["mfa-enroll-email-with-sms-enrolled"],
  "/api/v1/authn/skip": ["mfa-enroll-email-with-sms-enrolled"],
  "/api/v1/authn/factors": ["mfa-enroll-activate-email"],
  "/api/v1/authn/factors/:factorid/lifecycle/resend": [
    "mfa-enroll-activate-email",
  ],
  "/api/v1/authn/factors/:factorid/lifecycle/activate": ["success-001"],
};

// email verification
const emailVerificationMocks = {
  "/api/v1/authn": ["mfa-required-email"],
  "/api/v1/authn/factors/:factorid/verify/resend": ["mfa-challenge-email"],
...
const fastpassUnassignedApp = {
  "/idp/idx/introspect": ["error-400-user-not-assigned"],
  "/idp/idx/authenticators/okta-verify/launch": [
    "error-400-user-not-assigned-2",
  ],
  "/idp/idx/identify": ["error-400-user-not-assigned-3"],
};
...
const windowAuthnLoopbackFailfast = {
  "/idp/idx/introspect": ["identify-with-device-probing-loopback"],
  "/idp/idx/authenticators/poll": ["identify"],
  "/idp/idx/authenticators/okta-verify/launch": [
    "identify-with-device-launch-authenticator",
  ],
  "/idp/idx/authenticators/poll/cancel": [
...
const desktopSmartProbe = {
  ...
  "/idp/idx/authenticators/poll/cancel": ["smart-probing-required"],
  "/idp/idx/enroll": ["enroll-profile-new"],
};
...
const windowAuthnCustomUri = {
  ...
  "/idp/idx/authenticators/poll": ["identify-with-device-launch-authenticator"],
  "/idp/idx/authenticators/okta-verify/launch": [
    "identify-with-device-launch-authenticator",
  ],
};
...
const appleRedirectSsoExtension = {
  "/idp/idx/introspect": ["identify-with-apple-redirect-sso-extension"],
};

// device probe: Apple authenticator with Credential SSO extension
const appleCredentialSsoExtension = {
  "/idp/idx/introspect": ["identify-with-apple-credential-sso-extension"],
...
const androidAuthnLoopbackFailfast = {
  "/idp/idx/introspect": ["identify-with-device-probing-loopback"],
  "/idp/idx/authenticators/poll": ["identify-with-app-link"],
  "/idp/idx/authenticators/okta-verify/launch": ["identify-with-app-link"],
  "/idp/idx/authenticators/poll/cancel": [
...
// ov enroll
const ovEnroll = {
  "/idp/idx/introspect": ["authenticator-enroll-ov-qr"],
  "/idp/idx/credential/enroll": ["authenticator-enroll-ov-via-email"],
  "/idp/idx/challenge/send": ["authenticator-enroll-ov-email"],
  "/idp/idx/challenge/resend": ["authenticator-enroll-ov-email"],
  "/idp/idx/challenge/poll": ["authenticator-enroll-ov-email", "success"],
};
...
const ovTotpSuccess = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-okta-verify-totp"],
  "/idp/idx/challenge/answer": ["success"],
};
...
const onlyOVAuthenticatorTOTPChallenge = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-okta-verify-totp-onlyOV"],
  "/idp/idx/challenge/answer": ["success"],
};
...
const totpEnableBiometrics = {
  "/idp/idx/introspect": ["authenticator-verification-okta-verify-totp"],
  "/idp/idx/challenge/answer": [
    "error-okta-verify-uv-totp-verify-enable-biometrics",
  ],
};
...
const ovPushSuccess = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-okta-verify-push"],
  "/idp/idx/challenge/poll": [
    "authenticator-verification-okta-verify-push",
    "authenticator-verification-okta-verify-push",
    "authenticator-verification-okta-verify-push",
...
const ovPushWait = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-okta-verify-push"],
  "/idp/idx/challenge/poll": ["authenticator-verification-okta-verify-push"],
};
...
const ovSignedNonceCustomUri = {
  ...
  "/idp/idx/authenticators/poll/cancel": ["identify"],
};
...
const emailVerificationNoEmail = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-email-no-profile"],
  "/idp/idx/challenge/poll": ["authenticator-verification-email-no-profile"],
};

// phone enroll safe mode
const phoneEnroll = {
  "/idp/idx/introspect": ["authenticator-enroll-phone"],
  "/idp/idx/challenge/answer": [
...
const duoMFAEnroll = {
  "/idp/idx/introspect": ["authenticator-enroll-select-authenticator"],
  "/idp/idx/credential/enroll": ["authenticator-enroll-duo"],
  "/idp/idx/challenge/answer": [
    "success",
...
const duoMFAVerify = {
  "/idp/idx/introspect": ["authenticator-verification-select-authenticator"],
  "/idp/idx/challenge": ["authenticator-verification-duo"],
  "/idp/idx/challenge/answer": [
    "success",
    //'error-authenticator-verification-duo',
  ],
...
const safeModePoll = {
  "/idp/idx/introspect": ["identify-with-password"],
  "/idp/idx/identify": ["authenticator-enroll-select-authenticator"],
  "/idp/idx/credential/enroll": ["safe-mode-polling"],
  "/idp/idx/poll": [
    // 'safe-mode-polling',
    "safe-mode-polling",
...
const passwordRecovery = {
  "/idp/idx/introspect": ["identify-recovery"],
  "/idp/idx/identify": [
    // 'error-identify-access-denied',
    "authenticator-verification-select-authenticator",
  ],
...
const idpAuthenticator = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-idp"],
  "/idp/idx/credential/enroll": ["authenticator-enroll-idp"],
};

const userUnlockAccount = {
  "/idp/idx/introspect": ["identify-with-unlock-account-link"],
  "/idp/idx/unlock-account": ["user-unlock-account"],
  "/idp/idx/challenge": [
    // 'error-400-unlock-account',
    // 'authenticator-verification-data-phone-sms-then-voice',
    "authenticator-verification-email",
  ],
  "/idp/idx/challenge/answer": ["user-account-unlock-success"],
};
...
const symantecVipAuthenticator = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-symantec-vip"],
  "/idp/idx/challenge/answer": [
    // 'error-authenticator-verification-symantec-vip-invalid-passcode'
    "success",
  ],
  "/idp/idx/credential/enroll": ["authenticator-enroll-symantec-vip"],
};

const emailChallengeConsent = {
  "/idp/idx/introspect": ["email-challenge-consent"],
  "/idp/idx/consent": [
...
const googleAuthenticatorVerify = {
  "/idp/idx/introspect": ["authenticator-verification-select-authenticator"],
  "/idp/idx/challenge": ["authenticator-verification-google-authenticator"],
  "/idp/idx/challenge/answer": [
    "success",
...
const yubikeyAuthenticator = {
  ...
  "/idp/idx/challenge": ["authenticator-verification-yubikey"],
  "/idp/idx/challenge/answer": ["success"],
  "/idp/idx/credential/enroll": ["authenticator-enroll-yubikey"],
};
...
const secondaryEmail = {
  ...
  "/idp/idx/skip": ["success-with-app-user"],
  "/idp/idx/enroll/new": ["success-with-app-user"],
};

const selfServiceRegistration = {
  "/api/v1/authn": ["success-001"],
  "/api/v1/registration/form": ["form"],
  "/api/v1/registration/:id/register": ["register"],
  "/idp/idx/enroll/new": ["profile-enrollment-string-fields-options"],
};
...
const selectOktaVerifyMethod = {
  "/idp/idx/introspect": ["identify-with-password"],
  "/idp/idx/identify": ["authenticator-enroll-ov-via-email"],
  "/idp/idx/challenge": [
    "authenticator-verification-okta-verify-push-autoChallenge-on",
  ],
  "/idp/idx/authenticators/poll": [
